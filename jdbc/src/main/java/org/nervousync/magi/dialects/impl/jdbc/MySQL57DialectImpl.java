...
/**
 * <h2 class="en-US">MySQL 5.7 database dialect implementation class</h2>
 * <h2 class="zh-CN">MySQL 5.7数据库方言实现类</h2>
 *
 * @author Steven Wee	<a href="mailto:wmkm0113@gmail.com">wmkm0113@gmail.com</a>
 * @version $Revision: 1.0.0 $ $Date: Nov 15, 2022 09:55:18 $
 */
@Provider(name = "MySQL57", titleKey = "MySQL57_Dialect_Title", descriptionKey = "MySQL_Dialect_Description")
...
public final class MySQL57DialectImpl extends MySQL50DialectImpl {

	/**
	 * <h3 class="en-US">Constructor method for MySQL 5.7 database dialect implementation class</h3>
	 * <h3 class="zh-CN">MySQL 5.7数据库方言实现类的构造方法</h3>
	 *
	 ...
	 */
	public MySQL57DialectImpl() throws DialectException {
		super();
	}
